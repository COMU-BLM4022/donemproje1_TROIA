...
Kategori dağılımı, her bir kategoride bulunan hizmet sayısını göstermektedir. Aşağıdaki grafik, veri setinde en çok alınan hizmet kategorilerini görselleştirmektedir.
```{r echo=FALSE}
# Kategori Dağılımı Grafiği
library(ggplot2)
category_distribution <- table(df$CategoryId)
...
*Grafikten görüleceği üzere, veri setinde en çok alınan hizmet kategorisi birinci sırada 4 ID'li "Eğitim" kategorisi, ikinci sırada ise 0 ID'li "Temizlik" kategorisi yer almaktadır*
